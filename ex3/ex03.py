...
class Product:
    def __init__(self, location1, stockofproduct):
...
laptops = Product(location1='Rajkot', stockofproduct=100)
foods = Product(location1='Surat', stockofproduct=200)
watches = Product(location1='Ahmedabad', stockofproduct=400)
t_shirt = Product(location1='Baroda', stockofproduct=999)
cars = Product('Mumbai', stockofproduct=21)
...
bikes = Movement(from_location='Rajkot', to_location='surat', productname='Honda', quantity=10, code=212)
fruits = Movement(from_location='Ahmadabad', to_location='Mumbai', productname='Apple', quantity=1, code=21)
vegitables = Movement(from_location='Jaipur', to_location='kota', productname='Tomato', quantity=50, code=11)
cars = Movement(from_location='Delhi', to_location='Kolkata', productname='i-20', quantity=40, code=1)
mobiles = Movement(from_location='Rajkot', to_location='Upleta', productname='iphone-12', quantity=2, code=23)

bikes.product_move()
cars.product_move()
mobiles.product_move()
fruits.product_move()
vegitables.product_move()
...
foods = Product(location1='Rajkot', stockofproduct=200)
foods.addlocation()
tv = Product(location1='Surat', stockofproduct=400)
tv.addlocation()
